...
<div class="container" itemscope itemtype="http://data-vocabulary.org/Person" >
	<div class="row">
		...
		<div class="col-lg-7 col-md-6 col-sm-9 col-xs-12" style="margin-bottom:15px;">
			...
			<h3 id="PageContent-Author-NameEn" style="text-align:center; margin-top:10px;" itemprop="additionalName">${ authorData.getFullNameEn() }</h3>
			
			//itemprop="alternateName">${ authorData.getFullNameEn() }</h3>
