			...
			<table cellspacing="0" cellpadding="0"> 
				...
				<tr>
					<td align="center" width="600" height="40">
						<p>
							<span style="font-size:18px; color:grey;">You have followed </span><strong style="font-size:20px;">${ authorData.getName() ! authorData.getNameEn() }</strong> 
						</p>
					</td>
				</tr>
				<tr>
					<td align="center" width="600" height="40">
						<div style="width:150px;-webkit-border-radius: 20px; -moz-border-radius: 20px; border-radius: 20px; display: block; border: solid 1px #46b8da">
							<a href="www.pratilipi.com${authorData.getPageUrl()}" style="line-height:30px;text-decoration: blink;font-size: 18px;">
