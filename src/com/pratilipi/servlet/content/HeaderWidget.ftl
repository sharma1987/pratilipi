                ...
                <ul class="dropdown-custom" role="menu" aria-labelledby="dLabel">
                  ...
                  <li onclick="subMenu( event, this );" style="position:relative">
		                ...
		                <ul class="dropdown-subMenu">
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/dakghar">Dakghar</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/ptr-lekhan-1">Ptr Lekhan(Marathi)</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/ptr-lekhan">Ptr Lekhan(Hindi)</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/april-tasavir-bole-chhe">April Tasavir Bole Chhe</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/mansi-lekhspardha">Mansi Lekhspardha</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/march-tasvir-bole-chhe">March Tasvir Bole Che</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/pratilipichi-kavyavel-spardha">Pratilipichi Kavyavel Spardha</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/esho-galpo-boli">Esho Galpo Boli</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/kk">Kondaadapadaadha Kaadhalgal</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/sidha-sawal">Sidha Sawal</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/tasvir-bole-che">Tasvir Bole Che</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/katha-masti">Katha Masti</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/pratilipi-katha-spardha">Pratilipi Katha Spardha</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/kavita-utsav-2015">Kavita Utsav - 2015</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/direct-encounter">Direct Encounter</a></li>
		                	<li class="subMenuItem" onclick="subMenuItemClick( event );" data-toggle="dropdown"><a href="/event/varta-mahotsav-2015">Varta Mahotsav - 2015</a></li>
